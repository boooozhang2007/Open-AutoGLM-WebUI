...
def check_model_api(base_url: str, model_name: str) -> bool:
    ...
    try:
        ...
        client = OpenAI(base_url=base_url, api_key="ms-3dd3f247-aa7d-4586-b2bf-acee47e2d213", timeout=10.0)
        ...
        if model_name in available_models:
            ...
            print("⚠️ WARNING")
            print(f"   Warning: Model '{model_name}' not found in the list.")
            print(f"   Available models:")
            for m in available_models[:10]:  # Show first 10 models
                print(f"     - {m}")
            if len(available_models) > 10:
                print(f"     ... and {len(available_models) - 10} more")
            print("   Proceeding anyway as the model might be valid but not listed.")
            all_passed = True
...
Examples:
    ...
    parser.add_argument(
        "--base-url",
        type=str,
        default=os.getenv("PHONE_AGENT_BASE_URL", "https://api-inference.modelscope.cn/v1"),
...
def main():
    ...
    model_config = ModelConfig(
        ...
        api_key="ms-3dd3f247-aa7d-4586-b2bf-acee47e2d213",
    )
